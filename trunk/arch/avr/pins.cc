...
{
	// Port A
	pins[AVR_PIN_PA0] = Pin("PA0", true);
	pins[AVR_PIN_PA1] = Pin("PA1", true);
	pins[AVR_PIN_PA2] = Pin("PA2", true);
	pins[AVR_PIN_PA3] = Pin("PA3", false);
	pins[AVR_PIN_PA4] = Pin("PA4", false);
	pins[AVR_PIN_PA5] = Pin("PA5", false);
	pins[AVR_PIN_PA6] = Pin("PA6", false);
	pins[AVR_PIN_PA7] = Pin("PA7", false);
	// Port B
